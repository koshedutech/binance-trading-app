...
export default function FuturesDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-4">
      ...
      <div className="mb-4">
        <CollapsibleCard
          title="Ginie AI Trader"
          subtitle="Autonomous futures trading with AI signals"
          icon={<Brain className="w-5 h-5" />}
          defaultExpanded={false}
          badge="AI"
          badgeColor="purple"
          headerClassName="bg-gradient-to-br from-purple-900/40 to-blue-900/40 border-purple-500/30"
        >
